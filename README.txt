...
Ensure the LM Studio server is running first. On Mac, go to the "Local Server" tab in LM Studio, and look for the green "Start Server" button (assuming LM Studio Version 0.2.24 (0.2.24)).
